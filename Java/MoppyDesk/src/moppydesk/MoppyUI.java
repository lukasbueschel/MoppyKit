...
import moppydesk.kit.MoppyKitUI;
import moppydesk.kit.MoppyKitPlayerOutput;
...
public class MoppyUI {
    ...
    // Moppy KIT funktioniert wie folgt: 
    protected void startMoppyKit() {
        rm.clearReceivers();

        String[] availablePorts = MoppyCOMBridge.getAvailableCOMPorts();
        // Der Port muss der des Arduino sein. Bei der Verwendung von mehreren 
        // Arduinos, muss der Code angepasst werden.
        ...
        // Das UI wird aktuell nur benötigt, um Eingaben über die Tastatur 
        // abzufangen.
        MoppyKitUI ui = new MoppyKitUI(outputs);
        ui.setVisible(true);
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                //ui.startup();
                ui.startMoppyKit();
                // Um das klassische Moppy Desk zu starten, muss lediglich 
                // ui.startup() anstelle von ui.startMoppyKit() aufgerufen 
                // werden.
            }
        });
    }
